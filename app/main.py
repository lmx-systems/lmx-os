...
Queue, Fleet State Manager, and Dispatch Optimizer skeleton behind a
single FastAPI app, per LMX_OS_Technical_Design_2.md.
...
NOT in this phase (see docs/ARCHITECTURE.md for the full breakdown):
  ...
  - Annotation and Learning Loop's nightly retraining job
  - Real Google Route Optimization / Twilio / Epicor credentials wiring
"""
